...
export default function UseStateHook() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={[styles.btn, styles.btnDiminuir]} onPress={() => { setNumero(numero - 1); }}>
        <Text style={styles.btnText}>Diminuir Valor</Text>
      </TouchableOpacity>
      <TouchableOpacity style={[styles.btn, styles.btnMultiplica]} onPress={() => { setNumero(numero * 2); }}>
